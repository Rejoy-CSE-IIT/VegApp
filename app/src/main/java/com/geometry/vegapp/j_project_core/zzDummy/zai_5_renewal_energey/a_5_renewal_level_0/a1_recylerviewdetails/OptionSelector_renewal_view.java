...
public class OptionSelector_renewal_view extends AppCompatActivity
{

    private static RecyclerView.Adapter adapter;
    private RecyclerView.LayoutManager layoutManager;
    private static RecyclerView recyclerView;
    private static ArrayList<optionDataModel_renewal_view> data;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recyclerView.addOnItemTouchListener(new recyclerTouchListener_class(getApplicationContext(), recyclerView, new recyclerTouchListener_class.ClickListener()
        {
            ...
            {
                optionDataModel_renewal_view dataE = data.get(position);

                Intent intent = new Intent(OptionSelector_renewal_view.this, viewrenewal.class);
        ...
        data = new ArrayList<optionDataModel_renewal_view>();
        ...
        adapter = new OptionAdapter_renewal_view(data,getApplicationContext());
    ...
    void getDataFromServer()
    {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getRenewalView_URL(),
                        ...
                        if(result_of_register.equals("true"))
                        {
                            ...
                            for(int i =0;i<count;i++)
                            {
                               ...
                               // int approved=0;
                                ...
                                data.add(new optionDataModel_renewal_view(
                ...
                new Response.ErrorListener()
                {
                    ...
                    {
                        Toast.makeText(OptionSelector_renewal_view.this,error.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
