...
public class a_0_renewalformEntryForm extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        seed_req_button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    builder=new AlertDialog.Builder(a_0_renewalformEntryForm.this);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getRenewal_Register_URL(),
                            new Response.Listener<String>()
                            {
                                ...
                                public void onResponse(String response)
                                {
                                    ...
                                    Toast.makeText(a_0_renewalformEntryForm.this, response, Toast.LENGTH_LONG).show();
                                    ...
                                    if(result_of_register.equals("true"))
                                    {
                                      ...
                                      //  if(homepage_activity.TESTING_MODE)
                                        Toast.makeText(a_0_renewalformEntryForm.this, "Renewal Registration Successful!", Toast.LENGTH_LONG).show();


                                        Intent intent = new Intent(a_0_renewalformEntryForm.this, aa_ai_5_OptionSelector_rnwWindow.class);
                                    ...
                                    else
                                    {
                                        ...
                                        seed_label.setText("Renewal energey source Registration Failed Try again !!");
                                    }
                                    bitmap_P=null;
                                }
                            },
                            new Response.ErrorListener()
                            {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    Toast.makeText(a_0_renewalformEntryForm.this,error.toString(),Toast.LENGTH_LONG).show();
                                }
                            }){
                        @Override
            ...
            if(intent_resultdata!=null)
            {
                ...
                else
                {
                 ...
                 //   utilClass.getToast("NOT NULL",fertformEntryForm.this);
                    ...
                    {
                        File actualImage;
                        actualImage = FileUtil.from(a_0_renewalformEntryForm.this, mImageUri);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                if(homepage_activity.TESTING_MODE)
                {
                    helperFunctions_class.showToast(a_0_renewalformEntryForm.this, "Inside Login Function");
                }
                helperFunctions_class.logOut_reset_flags(a_0_renewalformEntryForm.this);
                Intent intent = new Intent(a_0_renewalformEntryForm.this, login_activity.class);
                startActivity(intent);
                finish();
