...
public class viewrenewal extends AppCompatActivity
{
    ...
    String phone ="5554",  message="hello";
    @Override
    protected void onCreate(Bundle savedInstanceState)
    {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.zzz_viewrenewal);
...
*/
        ...
        approve.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getApproval_renewal_URL(),
                        new Response.Listener<String>()
                        {
                            ...
                            public void onResponse(String response)
                            {
                                ...
                                {
                                    Toast.makeText(viewrenewal.this, "Approved --+"+mobile_n0, Toast.LENGTH_LONG).show();
                                    ...
                                    sendSMS(Integer.toString(5554 ) ,"Your Post has been approved by VegMarket");
                                      ...
                                      Intent intent = new Intent(viewrenewal.this, OptionSelector_renewal_view.class);
                        ...
                        new Response.ErrorListener()
                        {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(viewrenewal.this,error.toString(),Toast.LENGTH_LONG).show();
                            }
                        }){
                    @Override
        ...
        delete.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getDelete_renewal_URL(),
                        new Response.Listener<String>()
                        {
                            @Override
                            public void onResponse(String response)
                            {
                                // remember response is the sring that you sent from server open php
                                Toast.makeText(viewrenewal.this, response, Toast.LENGTH_LONG).show();
                                Toast.makeText(viewrenewal.this, Integer.toString(userid), Toast.LENGTH_LONG).show();
                                Gson gson = new Gson();
                                //*
                                JsonElement element = gson.fromJson (response, JsonElement.class);
                                JsonObject jsonObj = element.getAsJsonObject();
                                ...
                                if(result_of_register.equals("true"))
                                {
                                    Toast.makeText(viewrenewal.this, "deleted", Toast.LENGTH_LONG).show();

                                    // Intent intent = new Intent(seedformEntryForm.this, optionDataModel_seed.class);
...
/*
        ...
        switch (requestCode)
        {
            case MY_PERMISSIONS_REQUEST_SEND_SMS:
            {
                        ...
                        && grantResults[0] == PackageManager.PERMISSION_GRANTED)
                {
                    ...
                    Toast.makeText(getApplicationContext(), "SMS sentsssssssssss.",
    ...
    void  sendSMS(String toPhoneNumber,String smsMessage)
    {
