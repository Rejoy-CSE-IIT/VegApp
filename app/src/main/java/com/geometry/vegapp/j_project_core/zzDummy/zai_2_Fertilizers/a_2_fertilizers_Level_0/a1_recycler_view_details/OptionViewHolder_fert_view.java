...
public class OptionViewHolder_fert_view extends  RecyclerView.ViewHolder
{
    ...
    public OptionViewHolder_fert_view(View itemView, final Context ctx)
    {
        super(itemView);
        this.view =itemView;
        this.ctx=ctx;
...
/*
    ...
    public void bind(final optionDataModel_fert_view data)
    {
