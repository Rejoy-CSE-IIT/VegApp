...
public class OptionSelector_train_view extends AppCompatActivity
{

    private static RecyclerView.Adapter adapter;
    private RecyclerView.LayoutManager layoutManager;
    private static RecyclerView recyclerView;
    private static ArrayList<optionDataModel_train_view> data;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recyclerView.addOnItemTouchListener(new recyclerTouchListener_class(getApplicationContext(), recyclerView, new recyclerTouchListener_class.ClickListener()
        {
            ...
            {
                optionDataModel_train_view dataE = data.get(position);

                Intent intent = new Intent(OptionSelector_train_view.this, viewTrain.class);
        ...
        data = new ArrayList<optionDataModel_train_view>();
        ...
        adapter = new OptionAdapter_train_view(data,getApplicationContext());
    ...
    void getDataFromServer()
    {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getTrainView_URL(),
                        ...
                        if(result_of_register.equals("true"))
                        {
                            ...
                            for(int i =0;i<count;i++)
                            {
                               ...
                               // int approved=0;
                                ...
                                data.add(new optionDataModel_train_view(
                ...
                new Response.ErrorListener()
                {
                    ...
                    {
                        Toast.makeText(OptionSelector_train_view.this,error.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
