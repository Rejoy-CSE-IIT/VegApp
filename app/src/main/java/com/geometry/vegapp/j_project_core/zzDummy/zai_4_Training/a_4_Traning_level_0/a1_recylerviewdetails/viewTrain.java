...
public class viewTrain extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.zzz_viewtrain);
...
*/
        ...
        approve.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getApproval_train_URL(),
                        new Response.Listener<String>()
                        {
                            ...
                            public void onResponse(String response)
                            {
                                ...
                                {
                                    Toast.makeText(viewTrain.this, "Approved --+"+mobile_n0, Toast.LENGTH_LONG).show();
                                    ...
                                    sendSMS(Integer.toString(5554 ) ,"Your Post has been approved by VegMarket");
                                      ...
                                      Intent intent = new Intent(viewTrain.this, OptionSelector_train_view.class);
                        ...
                        new Response.ErrorListener()
                        {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(viewTrain.this,error.toString(),Toast.LENGTH_LONG).show();
                            }
                        }){
                    @Override
        ...
        delete.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getDelete_train_URL(),
                        new Response.Listener<String>()
                        {
                            @Override
                            public void onResponse(String response)
                            {
                                // remember response is the sring that you sent from server open php
                                Toast.makeText(viewTrain.this, response, Toast.LENGTH_LONG).show();
                                Toast.makeText(viewTrain.this, Integer.toString(userid), Toast.LENGTH_LONG).show();
                                Gson gson = new Gson();
                                //*
                                JsonElement element = gson.fromJson (response, JsonElement.class);
                                JsonObject jsonObj = element.getAsJsonObject();
                                ...
                                if(result_of_register.equals("true"))
                                {
                                    Toast.makeText(viewTrain.this, "deleted", Toast.LENGTH_LONG).show();
