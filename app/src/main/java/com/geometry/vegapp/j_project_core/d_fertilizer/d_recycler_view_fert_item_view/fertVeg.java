package com.geometry.vegapp.j_project_core.d_fertilizer.d_recycler_view_fert_item_view;
...
import com.geometry.vegapp.j_project_core.d_fertilizer.a_recycler_view_fert_options.a_recycler_view_fert_options_display_activity;
...
public class fertVeg extends AppCompatActivity
{
...
*/
        ...
        float screenWidth= helperFunctions_class.getScreenWidth(fertVeg.this );
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getApproval_veg_URL(),
                        new Response.Listener<String>()
                        {
                            ...
                            public void onResponse(String response)
                            {
                                ...
                                {
                                    Toast.makeText(fertVeg.this, "Approved --+"+mobile_n0, Toast.LENGTH_LONG).show();
                                  ...
                                  //  sendSMS(Integer.toString(5554) ,"Your Post has been approved by VegMarket");
                                      ...
                                      sendSMSMessage();
                                      Intent intent = new Intent(fertVeg.this, a_recycler_view_fert_options_display_activity.class);
                        ...
                        new Response.ErrorListener()
                        {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(fertVeg.this,error.toString(),Toast.LENGTH_LONG).show();
                            }
                        }){
                    @Override
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getDelete_veg_URL(),
                        new Response.Listener<String>()
                        {
                            ...
                            public void onResponse(String response)
                            {
                                ...
                                if(result_of_register.equals("true"))
                                {
                                    Toast.makeText(fertVeg.this, "deleted", Toast.LENGTH_LONG).show();
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getRating_veg_Register_URL(),
                        new Response.Listener<String>()
                        {
                            ...
                            public void onResponse(String response)
                            {
                                ...
                                if(result_of_register.equals("true"))
                                {
                                    Toast.makeText(fertVeg.this, " rating updated", Toast.LENGTH_LONG).show();
                                }
                                else
                                {
                                    //Toast.makeText(Register.this, "Registration  Failed", Toast.LENGTH_LONG).show();
