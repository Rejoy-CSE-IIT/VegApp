package com.geometry.vegapp.j_project_core.e_plant.c_recycler_view_plant_entry;
                                ...
                                public void onResponse(String response)
                                {
                                    ...
                                    if(result_of_register.equals("true"))
                                    {
                                      ...
                                      //  if(homepage_activity.TESTING_MODE)
                                        ...
                                        Intent intent = new Intent(plantformEntryForm.this, a_recycler_view_seed_options_display_activity.class);
