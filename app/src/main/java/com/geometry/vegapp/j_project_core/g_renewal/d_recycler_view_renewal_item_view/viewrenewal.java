package com.geometry.vegapp.j_project_core.g_renewal.d_recycler_view_renewal_item_view;
...
import com.geometry.vegapp.j_project_core.g_renewal.a_recycler_view_renewal_options.a_recycler_view_renewal_options_display_activity;
...
*/
        ...
        float screenWidth= helperFunctions_class.getScreenWidth(viewrenewal.this );
                            ...
                            public void onResponse(String response)
                            {
                                ...
                                if(result_of_register.equals("true"))
                                {
                                  ...
                                  //  sendSMS(Integer.toString(5554) ,"Your Post has been approved by VegMarket");
                                      ...
                                      sendSMSMessage();
                                      Intent intent = new Intent(viewrenewal.this, a_recycler_view_renewal_options_display_activity.class);
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getRating_veg_Register_URL(),
                        new Response.Listener<String>()
                        {
                            ...
                            public void onResponse(String response)
                            {
                                ...
                                if(result_of_register.equals("true"))
                                {
                                    Toast.makeText(viewrenewal.this, " rating updated", Toast.LENGTH_LONG).show();
                                }
                                else
                                {
                                    //Toast.makeText(Register.this, "Registration  Failed", Toast.LENGTH_LONG).show();
