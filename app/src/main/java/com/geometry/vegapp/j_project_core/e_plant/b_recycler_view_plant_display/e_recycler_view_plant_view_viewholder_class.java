...
public class e_recycler_view_plant_view_viewholder_class extends  RecyclerView.ViewHolder
{
   ...
   // TextView place;
    ...
    public e_recycler_view_plant_view_viewholder_class(View itemView, final Context ctx, final Activity act)
    {
        super(itemView);
        this.view =itemView;
        this.ctx=ctx;
...
/*
    ...
    public void bind(final d_recycler_view_plant_view_datamodel_class data)
    {
