package com.geometry.vegapp.j_project_core.c_vegetable.c_recycler_view_veg_entry;
                                ...
                                public void onResponse(String response)
                                {
                                    ...
                                    if(result_of_register.equals("true"))
                                    {
                                      ...
                                      //  if(homepage_activity.TESTING_MODE)
                                        ...
                                        Intent intent = new Intent(vegformEntryForm.this, a_recycler_view_seed_options_display_activity.class);
