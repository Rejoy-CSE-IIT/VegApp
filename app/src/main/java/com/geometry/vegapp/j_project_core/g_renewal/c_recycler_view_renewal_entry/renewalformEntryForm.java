package com.geometry.vegapp.j_project_core.g_renewal.c_recycler_view_renewal_entry;
                                ...
                                public void onResponse(String response)
                                {
                                    ...
                                    if(result_of_register.equals("true"))
                                    {
                                      ...
                                      //  if(homepage_activity.TESTING_MODE)
                                        ...
                                        Intent intent = new Intent(renewalformEntryForm.this, a_recycler_view_seed_options_display_activity.class);
