package com.geometry.vegapp.j_project_core.f_train.c_recycler_view_train_entry;
                            ...
                            new Response.Listener<String>()
                            {
                                ...
                                public void onResponse(String response)
                                {
                                    ...
                                    if(result_of_register.equals("true"))
                                    {
                                      ...
                                      //  if(homepage_activity.TESTING_MODE)
                                        Toast.makeText(trainformEntryForm.this, "Seed Registration Successful!", Toast.LENGTH_LONG).show();


                                        Intent intent = new Intent(trainformEntryForm.this, a_recycler_view_seed_options_display_activity.class);
