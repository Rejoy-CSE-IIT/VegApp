...
import com.geometry.vegapp.d_ImageProcessing.PinchZoomImageView_class;
...
public class a_0_trainformEntryForm extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.activity_a_0_trainform_entry_form);
        ...
        seed_req_button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    builder=new AlertDialog.Builder(a_0_trainformEntryForm.this);
                ...
                else
                {
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getTrain_Register_URL(),
                            new Response.Listener<String>()
                            {
                                ...
                                public void onResponse(String response)
                                {
                                    ...
                                    Toast.makeText(a_0_trainformEntryForm.this, response, Toast.LENGTH_LONG).show();
                                    ...
                                    if(result_of_register.equals("true"))
                                    {
                                      ...
                                      //  if(homepage_activity.TESTING_MODE)
                                        Toast.makeText(a_0_trainformEntryForm.this, "Agency Registration Successful!", Toast.LENGTH_LONG).show();


                                        Intent intent = new Intent(a_0_trainformEntryForm.this, aa_ai_4_OptionSelector_trnWindow.class);
                            ...
                            new Response.ErrorListener()
                            {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    Toast.makeText(a_0_trainformEntryForm.this,error.toString(),Toast.LENGTH_LONG).show();
                                }
                            }){
                        @Override
            ...
            if(intent_resultdata!=null)
            {
                ...
                else
                {
                 ...
                 //   utilClass.getToast("NOT NULL",fertformEntryForm.this);
                    ...
                    {
                        File actualImage;
                        actualImage = FileUtil.from(a_0_trainformEntryForm.this, mImageUri);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                if(homepage_activity.TESTING_MODE)
                {
                    helperFunctions_class.showToast(a_0_trainformEntryForm.this, "Inside Login Function");
                }
                helperFunctions_class.logOut_reset_flags(a_0_trainformEntryForm.this);
                Intent intent = new Intent(a_0_trainformEntryForm.this, login_activity.class);
                startActivity(intent);
                finish();
