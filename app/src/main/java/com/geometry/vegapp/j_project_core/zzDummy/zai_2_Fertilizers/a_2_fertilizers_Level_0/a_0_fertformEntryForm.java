package com.geometry.vegapp.j_project_core.zzDummy.zai_2_Fertilizers.a_2_fertilizers_Level_0;
...
public class a_0_fertformEntryForm extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        seed_req_button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    builder=new AlertDialog.Builder(a_0_fertformEntryForm.this);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getFert_Register_URL(),
                            new Response.Listener<String>()
                            {
                                ...
                                public void onResponse(String response)
                                {
                                    ...
                                    Toast.makeText(a_0_fertformEntryForm.this, response, Toast.LENGTH_LONG).show();
                                    ...
                                    if(result_of_register.equals("true"))
                                    {
                                      ...
                                      //  if(homepage_activity.TESTING_MODE)
                                        Toast.makeText(a_0_fertformEntryForm.this, "Fertilizer Registration Successful!", Toast.LENGTH_LONG).show();


                                        Intent intent = new Intent(a_0_fertformEntryForm.this, aa_ai_2_OptionSelector_fertWindow.class);
                            ...
                            new Response.ErrorListener()
                            {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    Toast.makeText(a_0_fertformEntryForm.this,error.toString(),Toast.LENGTH_LONG).show();
                                }
                            }){
                        @Override
            ...
            if(intent_resultdata!=null)
            {
                ...
                else
                {
                 ...
                 //   utilClass.getToast("NOT NULL",fertformEntryForm.this);
                    ...
                    {
                        File actualImage;
                        actualImage = FileUtil.from(a_0_fertformEntryForm.this, mImageUri);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                if(homepage_activity.TESTING_MODE)
                {
                    helperFunctions_class.showToast(a_0_fertformEntryForm.this, "Inside Login Function");
                }
                helperFunctions_class.logOut_reset_flags(a_0_fertformEntryForm.this);
                Intent intent = new Intent(a_0_fertformEntryForm.this, login_activity.class);
                startActivity(intent);
                finish();
