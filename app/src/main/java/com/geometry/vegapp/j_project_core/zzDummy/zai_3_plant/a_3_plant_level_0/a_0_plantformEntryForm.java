package com.geometry.vegapp.j_project_core.zzDummy.zai_3_plant.a_3_plant_level_0;
...
public class a_0_plantformEntryForm extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        seed_req_button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    builder=new AlertDialog.Builder(a_0_plantformEntryForm.this);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getPlant_Register_URL(),
                            new Response.Listener<String>()
                            {
                                ...
                                public void onResponse(String response)
                                {
                                    ...
                                    Toast.makeText(a_0_plantformEntryForm.this, response, Toast.LENGTH_LONG).show();
                                    ...
                                    if(result_of_register.equals("true"))
                                    {
                                      ...
                                      //  if(homepage_activity.TESTING_MODE)
                                        Toast.makeText(a_0_plantformEntryForm.this, "Plant Registration Successful!", Toast.LENGTH_LONG).show();


                                        Intent intent = new Intent(a_0_plantformEntryForm.this, aa_ai_3_OptionSelector_plantWindow.class);
                            ...
                            new Response.ErrorListener()
                            {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    Toast.makeText(a_0_plantformEntryForm.this,error.toString(),Toast.LENGTH_LONG).show();
                                }
                            }){
                        @Override
            ...
            if(intent_resultdata!=null)
            {
                ...
                else
                {
                 ...
                 //   utilClass.getToast("NOT NULL",fertformEntryForm.this);
                    ...
                    {
                        File actualImage;
                        actualImage = FileUtil.from(a_0_plantformEntryForm.this, mImageUri);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                if(homepage_activity.TESTING_MODE)
                {
                    helperFunctions_class.showToast(a_0_plantformEntryForm.this, "Inside Login Function");
                }
                helperFunctions_class.logOut_reset_flags(a_0_plantformEntryForm.this);
                Intent intent = new Intent(a_0_plantformEntryForm.this, login_activity.class);
                startActivity(intent);
                finish();
