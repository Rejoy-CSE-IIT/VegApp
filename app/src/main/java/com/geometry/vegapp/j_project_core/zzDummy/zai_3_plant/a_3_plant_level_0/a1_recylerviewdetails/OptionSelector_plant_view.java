...
public class OptionSelector_plant_view extends AppCompatActivity
{

    private static RecyclerView.Adapter adapter;
    private RecyclerView.LayoutManager layoutManager;
    private static RecyclerView recyclerView;
    private static ArrayList<optionDataModel_plant_view> data;
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        recyclerView.addOnItemTouchListener(new recyclerTouchListener_class(getApplicationContext(), recyclerView, new recyclerTouchListener_class.ClickListener()
        {
            ...
            {
                optionDataModel_plant_view dataE = data.get(position);

                Intent intent = new Intent(OptionSelector_plant_view.this, viewplant.class);
        ...
        data = new ArrayList<optionDataModel_plant_view>();
        ...
        adapter = new OptionAdapter_plant_view(data,getApplicationContext());
    ...
    void getDataFromServer()
    {
        StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getPlantView_URL(),
                        ...
                        if(result_of_register.equals("true"))
                        {
                            ...
                            for(int i =0;i<count;i++)
                            {
                               ...
                               // int approved=0;
                                ...
                                data.add(new optionDataModel_plant_view(
                ...
                new Response.ErrorListener()
                {
                    ...
                    {
                        Toast.makeText(OptionSelector_plant_view.this,error.toString(),Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
