...
public class OptionViewHolder_train_view extends  RecyclerView.ViewHolder
{
    ...
    public OptionViewHolder_train_view(View itemView, final Context ctx)
    {
        super(itemView);
        this.view =itemView;
        this.ctx=ctx;
...
/*
    ...
    public void bind(final optionDataModel_train_view data)
    {
