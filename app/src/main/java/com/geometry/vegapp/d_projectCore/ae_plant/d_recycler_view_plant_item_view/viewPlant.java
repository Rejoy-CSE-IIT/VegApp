package com.geometry.vegapp.d_projectCore.ae_plant.d_recycler_view_plant_item_view;
...
public class viewPlant extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        setContentView(R.layout.zzz_viewplant);
...
*/
        ...
        float screenWidth= helperFunctions_class.getScreenWidth(viewPlant.this );
        ...
        approve.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getApproval_plant_URL(),
                        new Response.Listener<String>()
                        {
                            ...
                            public void onResponse(String response)
                            {
                                ...
                                {
                                    Toast.makeText(viewPlant.this, "Approved --+"+mobile_n0, Toast.LENGTH_LONG).show();
                                    ...
                                    message= "Your Plant post is arrpoved with id "+ Integer.toString(postid);
                                    sendSMSMessage();
                                    Intent intent = new Intent(viewPlant.this, a_recycler_view_plant_options_display_activity.class);
                        ...
                        new Response.ErrorListener()
                        {
                            ...
                            public void onErrorResponse(VolleyError error) {
                                Toast.makeText(viewPlant.this,error.toString(),Toast.LENGTH_LONG).show();
                            }
                        }){
                    @Override
        ...
        delete.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getDelete_plant_URL(),
                        new Response.Listener<String>()
                        {
                            @Override
                            public void onResponse(String response)
                            {
                                // remember response is the sring that you sent from server open php
                                Toast.makeText(viewPlant.this, response, Toast.LENGTH_LONG).show();
                                Toast.makeText(viewPlant.this, Integer.toString(userid), Toast.LENGTH_LONG).show();
                                Gson gson = new Gson();
                                //*
                                JsonElement element = gson.fromJson (response, JsonElement.class);
                                JsonObject jsonObj = element.getAsJsonObject();
        ...
        buttonrating.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getRating_plant_Register_URL(),
                        new Response.Listener<String>()
                        {
                            @Override
                            public void onResponse(String response)
                            {
                                ...
                                if(result_of_register.equals("true"))
                                {
                                    Toast.makeText(viewPlant.this, " rating updated", Toast.LENGTH_LONG).show();
                                }
                                else
                                {
                                    //Toast.makeText(Register.this, "Registration  Failed", Toast.LENGTH_LONG).show();
