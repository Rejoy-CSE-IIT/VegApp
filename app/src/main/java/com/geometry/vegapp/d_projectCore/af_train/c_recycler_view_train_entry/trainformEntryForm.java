package com.geometry.vegapp.d_projectCore.af_train.c_recycler_view_train_entry;
...
public class trainformEntryForm extends AppCompatActivity
{
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        seed_req_button.setOnClickListener(new View.OnClickListener()
        {
            ...
            public void onClick(View v)
            {
                ...
                {
                    builder=new AlertDialog.Builder(trainformEntryForm.this);
                    ...
                    StringRequest stringRequest = new StringRequest(Request.Method.POST, webPageLinks_class.getTrain_Register_URL(),
                            new Response.Listener<String>()
                            {
                                ...
                                public void onResponse(String response)
                                {
                                    ...
                                    if(homepage_activity.TESTING_MODE)
                                        Toast.makeText(trainformEntryForm.this, response, Toast.LENGTH_LONG).show();
                                    ...
                                    if(result_of_register.equals("true"))
                                    {
                                        ...
                                        //  if(homepage_activity.TESTING_MODE)
                                        Toast.makeText(trainformEntryForm.this, "Train Registration Successful!", Toast.LENGTH_LONG).show();


                                        Intent intent = new Intent(trainformEntryForm.this, a_recycler_view_train_options_display_activity.class);
                            ...
                            new Response.ErrorListener()
                            {
                                ...
                                public void onErrorResponse(VolleyError error) {
                                    Toast.makeText(trainformEntryForm.this,error.toString(),Toast.LENGTH_LONG).show();
                                }
                            }){
                        @Override
        ...
        if (requestCode == REQUEST_OPEN_GALLEY && resultCode ==RESULT_OK)
        {
            ...
            if(intent_resultdata!=null)
            {
                ...
                else
                {
                    ...
                    {
                        File actualImage;
                        actualImage = FileUtil.from(trainformEntryForm.this, mImageUri);
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        switch (item.getItemId()) {
            case R.id.logout:
                ...
                if(homepage_activity.TESTING_MODE)
                {
                    helperFunctions_class.showToast(trainformEntryForm.this, "Inside Login Function");
                }
                helperFunctions_class.logOut_reset_flags(trainformEntryForm.this);
                Intent intent = new Intent(trainformEntryForm.this, login_activity.class);
                startActivity(intent);
                finish();
